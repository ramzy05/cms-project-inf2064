  ...
  <section id="histoire">
    <div class="histoire container">
      <div class="hist_content">
        ...
        ?><br><br>
        <p class="hist_text"><svg class="quote_left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
          ...
          </svg><?php echo $row['histoire'] ?><svg class="quote_right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
  ...
  <section id="conseil">
    <div class="conseil card_person container">
      <div class="conseil_descrip">
        ...
        ?><p>Notre conseil est constitué de <span id="nbr_membres">
            <?php
      ...
      <div class="members">
        <div class="clip_conseil clip"></div>
        <?php
        $number = 1;
  ...
  <section id="personnel">
    <div class="personnel card_person container">
      <div class="conseil_descrip">
        ...
        ?><p>Notre personnel est constitué de <span id="nbr_membres">
            <?php
            if ($$num_row < 10) echo '0' . $num_row;
            else echo $num_row;
            ?></h3></span> employés</p>
      ...
      <div class="members">
        <div class="clip_personnel clip"></div>
        <?php
        $number = 1;
        while ($row = mysqli_fetch_assoc($result)) {
          if ($number > 3) break;
          ...
          <div>
            ...
            ?>
              <p><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                ...
                </svg> <?php echo $row['descriptions'] ?></p>
            <?php } ?>
          </div>
        </div>
      </div>
